...
//       dataAttributes: ['identifier', 'description', 'name', 'preview', 'denotationChar'],
//       onOpen() {
//         return true;
//       },
//       onClose() {
...
//       },
//       // Style options
//       listItemClass: 'ql-command-list-item',
//       mentionContainerClass: 'ql-command-list-container',
//       mentionListClass: 'ql-command-list',
//     };
...
//     this.mentionContainer.onkeypress = this.onContainerKeypress.bind(this, event);
...
//     quill.keyboard.addBinding({
//       key: Keys.ENTER,
//     }, this.selectHandler.bind(this, event));
...
//     this.setCommandContainerPosition();
//     this.setIsOpen(true);
//   }
...
//   onContainerKeypress(ths, e) {
//     // console.log('onContainerKeypress', ths);
//     // console.log(e);
//   }

//   onContainerMouseMove() {
//     this.mentionContainer.enter =
//     this.suspendMouseEnter = false;
//   }
...
//     this.quill.insertEmbed(this.mentionCharPos, 'command', render, Quill.sources.USER);
//     this.quill.insertText(this.mentionCharPos, '', Quill.sources.USER);
//     this.quill.setSelection(this.mentionCharPos + 3, Quill.sources.USER);
//     this.hideCommandList();
//   }
...
// Quill.register('modules/command', Command);
