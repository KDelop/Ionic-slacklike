...
class Mention {
    constructor(quill, options) {
        ...
        this.options = {
            ...
            dataAttributes: ['identifier', 'username', 'id', 'value', 'denotationChar', 'link', 'target'],
            linkTarget: '_blank',
            onOpen() {
                return true;
            },
        ...
        const appChatContainer = document.querySelector('app-chat');
        appChatContainer.appendChild(this.mentionContainer);
